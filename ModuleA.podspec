...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/iOS-modularization/ModuleA"
  ...
  s.source       = { :git => "https://github.com/iOS-modularization/ModuleA.git", :tag => s.version.to_s }
